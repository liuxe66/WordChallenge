...
import com.liuxe.wordchallenge.utils.HttpLogger
...
object NetWorkHelper {
    ...
    private fun provideOkHttpClient(): OkHttpClient {
        ...
        val cacheFile = File(MyApp.context.cacheDir.path , "http_cache")
    ...
    class OnlineInterceptor : Interceptor {
        override fun intercept(chain: Interceptor.Chain): Response {
            ...
            val onlineCacheTime = 60 * 60 * 24 * 365 //在线的时候的缓存过期时间，如果想要不缓存，直接时间设置为0
